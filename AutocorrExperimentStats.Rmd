...
model <- brglm(Extinction ~ Mu * Gamma, data = data, family = "binomial")
...
summary_data <- data %>%
  ...
  summarise(
    ...
    ci_lower = binom.confint(x, n , methods = "wilson")$lower,
    ci_upper = binom.confint(x, n, methods = "wilson")$upper
  ) %>%
